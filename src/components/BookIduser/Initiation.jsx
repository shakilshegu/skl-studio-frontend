...
import { Calendar, Clock, Camera, Phone, Mail, Package, Wrench, Users, Star, User, Briefcase } from "lucide-react";
import moment from "moment";



export default function UserInitiation({role, bookingData, setActiveStep}) {
    console.log(bookingData,"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb");
                                ...
                                {Array.isArray(dates) &&
                                    [...dates] // clone to avoid mutating original
                                        ...
                                        .map((dateObj, index) => {
                                            ...
                                            return (
                                                <div key={index} className="bg-gradient-to-r from-green-50 to-blue-50 p-4 rounded-xl border border-green-100">
                                ...
                                {tabs.map((tab) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            {getTabIcon(tab)}
                                            <span>{tab}</span>
                                            {!adminPackage&&<div className={`px-2 py-1 rounded-full text-xs font-bold ${
                                                activeTab === tab 
...
{adminPackage&&<div className="p-8">
