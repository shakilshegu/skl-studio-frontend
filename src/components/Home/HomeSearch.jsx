...
const HomeSearch = () => {
  ...
  const [selectedTypeName, setSelectedTypeName] = useState("Choose your activity");
  ...
  const handleClearCategory = () => {
    ...
    setSelectedTypeName("Choose your activity");
    setIsDropdownOpen(false);
  };
                    ...
                    <>
                      ...
                      {selectedTypeId && (
                        <button
                          ...
                          className="w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors duration-200 border-b border-gray-100 text-gray-600 font-medium flex items-center gap-2"
                        >
                          <span className="text-[#892580]">✕</span> Clear selection
                        </button>
                      )}
